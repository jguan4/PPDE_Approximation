...
class NN_tf_2du:
	...
	@tf.function
	def forward(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf):
		num_layers = len(self.weights) 
		X = tf.concat((x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf), axis = -1)
	...
	@tf.function
	def derivatives(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf):
		with tf.GradientTape(persistent = True) as tape1:
			...
			with tf.GradientTape(persistent = True) as tape:
				...
				tape.watch(y_tf)
				tape.watch(t_tf)
				H1,H2 = self.forward(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf)
	...
	@tf.function
	def compute_residual(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target):
		u1, u2, u1_x, u1_y, u1_t, u1_xx, u1_yy, u1_xy, u2_x, u2_y, u2_t, u2_xx, u2_yy, u2_xy = self.derivatives(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf)
		f_res1,f_res2 = self.env.f_res(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, u1, u2, u1_x, u1_y, u1_t, u1_xx, u1_yy, u1_xy, u2_x, u2_y, u2_t, u2_xx, u2_yy, u2_xy)
	...
	@tf.function
	def compute_div(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target):
		u1, u2, u1_x, u1_y, u1_t, u1_xx, u1_yy, u1_xy, u2_x, u2_y, u2_t, u2_xx, u2_yy, u2_xy = self.derivatives(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf)
		div = u1_x+u2_y 
		div_err = div-target
		return div_err
	...
	@tf.function 
	def compute_neumann(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target):
		u1, u2, u1_x, u1_y, u1_t, u1_xx, u1_yy, u1_xy, u2_x, u2_y, u2_t, u2_xx, u2_yy, u2_xy = self.derivatives(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf)
		ub_n_p1, ub_n_p2  = self.env.neumann_bc(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, u1_x, u1_y, u2_x, u2_y)
		target1,target2 =tf.split(target, 2, axis = 1)
	...
	@tf.function
	def compute_solution(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target):
		u1_p, u2_p = self.forward(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf)
		target1,target2 =tf.split(target, 2, axis = 1)
		err1 = u1_p - target1
		err2 = u2_p - target2
		err = tf.concat((err1, err2),axis=0)
	...
	def loss(self, samples_list, save_toggle = False):
		...
		for i in range(len(samples_list)):
			...
			if name_i == "Res":
				f_res = self.compute_residual(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
				...
				err_do = self.compute_solution(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
				...
				err_n = self.compute_neumann(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf,target)
				...
				err_0 = self.compute_solution(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
				...
				f_res = self.compute_div(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
				f_u = f_res*np.sqrt(weight/N)
				loss_f = tf.math.reduce_sum(f_u**2)/2
				loss_val = loss_val + loss_f
	...
	@tf.function
	def construct_Jacobian_solution(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target, N, weight):
		with tf.GradientTape(persistent = True) as tape:
			err = self.compute_solution(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)*tf.math.sqrt(weight/N)
	...
	@tf.function
	def construct_Jacobian_residual(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target, N, weight):
		with tf.GradientTape(persistent = True) as tape:
			f_res = self.compute_residual(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
	...
	@tf.function
	def construct_Jacobian_reduced_residual(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target, N, weight):
		with tf.GradientTape(persistent = True) as tape:
			f_res = self.compute_reduced_residual(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
			err = (f_res)*tf.math.sqrt(weight/N)
			err = tf.reshape(err, [tf.reduce_prod(tf.shape(err)),1])
		weights_jacobians = tape.jacobian(err, self.weights)
		biases_jacobians = tape.jacobian(err, self.biases)
	...
	@tf.function
	def construct_Jacobian_div(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target, N, weight):
		with tf.GradientTape(persistent = True) as tape:
			f_res = self.compute_div(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)
			err = (f_res)*tf.math.sqrt(weight/N)
			err = tf.reshape(err, [tf.reduce_prod(tf.shape(err)),1])
	...
	@tf.function
	def construct_Jacobian_neumann(self, x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target, N, weight):
		with tf.GradientTape(persistent = True) as tape:
			err = self.compute_neumann(x_tf, y_tf, t_tf, xi_tf, w1_tf, w2_tf, target)*tf.math.sqrt(weight/N)
			err = tf.reshape(err, [tf.reduce_prod(tf.shape(err)),1])
		weights_jacobians = tape.jacobian(err, self.weights)
		biases_jacobians = tape.jacobian(err, self.biases)
		if biases_jacobians[-1] is None:
