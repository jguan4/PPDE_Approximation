...
# 0: train but don't save weights
# 1: train from scratch, save weights; 
# 2: train from existing weights
# 3: load weights, test and plot 
# 4: load weights, test and record

# env_toggle = "Poisson"; "CD_steady"; "Burger"; "CD_1D"
# layers, Ntr, test_size, 1/h, regularization_alpha, sampling method, env_toggle, type_weighting, net_toggle, opt_toggle, L
combs = [
    ...
    # [[64,64,64,64], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Dense","lm",1],       
    ...
    # [[32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Dense","lm"],    
    # # [[64,64,64,64], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Dense","lm"],    
    ...
    # # [[32,32,32,32], [0,0,0,100], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,300], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,700], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[64,64,64,64], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],       
    # # # [[32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","sgd",1],    
    # # [[32,32,32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Burger", [1,1,1,1],"Res","lm",1],    

    # # [[32,32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"], 
    # # [[32,32,32,32], [5000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"], 
    # # [[32,32,32,32], [3000,800,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"], 
    # [[32,32,32,32], [3000,600,0,400], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"], 
    # # [[32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"],    
    # # # [[32,32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"],    
    # # [[32,32,32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"],    
    # # [[32,32,32,32,32,32], [3000,600,0,300], 50, 128, [0], 2, "Burger", [1,1,0,1],"Res","lm"],    
    ...
    # # [[64,64,64,64], [3000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Dense","lm"],    
    ...
    # # [[32,32,32,32], [0,0,0,100], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,300], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32], [0,0,0,700], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32], [0,0,0,500], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # # [[64,64,64,64], [0,0,0,500], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],    
    # # [[32,32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],   
    # # [[32,32,32,32,32,32], [0,0,0,500], 50, 128, [0], 0, "Poisson", [1,1,1,1],"Res","lm",1],   

    # # [[32,32,32,32], [3000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],    
    # # [[32,32,32,32], [3000,800,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],    
    # # [[32,32,32,32], [5000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],    
    # [[32,32,32], [3000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],    
    # # [[32,32,32,32,32], [3000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],    
    # # [[32,32,32,32,32,32], [3000,600,0,0], 50, 128, [0], 2, "Poisson", [1,1,0,0],"Res","lm"],     

    # CD comp steady
    # [[32,32,32,32], [0,0,0,100], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32], [0,0,0,300], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32], [0,0,0,700], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32], [0,0,0,100], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[64,64,64,64], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    # [[32,32,32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Dense","lm",1],    
    
    # [[32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32,32], [5000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32,32], [3000,900,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32,32], [3000,600,600,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  
    # [[32,32,32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Dense","lm"],  

    # [[32,32,32,32], [0,0,0,100], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32], [0,0,0,300], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32], [0,0,0,700], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32], [0,0,0,100], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[64,64,64,64], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    # [[32,32,32,32,32,32], [0,0,0,500], 50, 32, [0], 0, "CD_steady", [1,1,1,1],"Res","lm",1],    
    
    # [[32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32,32], [5000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32,32], [3000,900,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32,32], [3000,600,600,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
    # [[32,32,32,32,32,32], [3000,600,300,0], 50, 32, [0], 2, "CD_steady", [1,1,1,0],"Res","lm"],  
...
for i in range(len(combs)):
    ...
    # output_name = "./Log/Output/PINN/{0}/PINN_{1}_{2}_{3}_{4}_{5}_{6}.txt".format(env_toggle,layers_str,Ns_str,test_size,space_n,regular_alphas_str,sampling_method)
    # if log_toggle:
    #     os.system("python3 DEMO_PINN.py {0} | tee {1}".format(input_str,output_name))
    # else:
    # os.system("python3 DEMO.py {0}".format(input_str))
